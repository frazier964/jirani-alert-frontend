...
export default function EmergencyActivation() {
  ...
  const activate = async () => {
    ...
    try {
      ...
      setSending(false)
      setProgress(0)
      setMessage('Unable to send emergency alert. Something went wrong while sending the emergency alert. Please try again.')
    }
  }
