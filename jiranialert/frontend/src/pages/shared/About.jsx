          ...
          <div className="relative mx-auto grid max-w-7xl gap-10 lg:grid-cols-2 lg:items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.55 }} className="space-y-6 text-white">
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                ...
                <Link to="/report-emergency" className="inline-flex items-center gap-2 rounded-full bg-[#E53935] px-6 py-3 font-bold text-white shadow-[0_18px_40px_rgba(229,57,53,0.3)] transition-transform hover:-translate-y-0.5">
                  Report Emergency
                </Link>
              </div>
            </motion.div>
