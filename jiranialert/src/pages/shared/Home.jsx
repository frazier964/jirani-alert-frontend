        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-20 items-center justify-between">
            <button type="button" onClick={() => goToSection('home')} className="flex items-center gap-3">
              ...
              <span className="text-sm sm:text-base font-bold tracking-wide text-[#2563EB]">JIRANI ALERT</span>
            </button>
            ...
            <div className="hidden lg:flex items-center gap-3">
              <Link to="/login" className="px-4 py-2 rounded-xl border border-slate-300 text-slate-700 font-semibold hover:border-[#2563EB] hover:text-[#2563EB] transition-colors">
                Login
              </Link>
              <Link to="/signup" className="px-4 py-2 rounded-xl bg-[#2563EB] text-white font-semibold shadow-[0_0_18px_rgba(37,99,235,0.45)] hover:shadow-[0_0_30px_rgba(37,99,235,0.6)] transition-all">
                Sign Up
              </Link>
            </div>
          ...
          <div className="lg:hidden border-t border-slate-200 bg-white/95 backdrop-blur">
            <div className="mx-auto max-w-7xl px-4 py-4 flex flex-col gap-3">
              ...
              <div className="flex gap-2 pt-2">
                ...
                <Link to="/signup" className="flex-1 px-4 py-2 rounded-xl bg-[#2563EB] text-center font-semibold text-white">
                  Sign Up
                </Link>
              </div>
            </div>
