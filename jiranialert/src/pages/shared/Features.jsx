      ...
      <main className="overflow-hidden">
        ...
        <section className="px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <div className="mx-auto grid max-w-7xl gap-6 lg:grid-cols-[1fr_1.1fr] lg:items-center">
            <Reveal className="rounded-[2rem] border border-slate-200 bg-[linear-gradient(135deg,#10254f_0%,#163b82_100%)] p-8 text-white shadow-[0_24px_70px_rgba(15,23,42,0.16)] sm:p-10">
              ...
              <div className="mt-7 grid gap-3 sm:grid-cols-2">
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-blue-100">Faster Awareness</p>
                  <p className="mt-2 text-sm text-white/90">Communities know instantly</p>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-blue-100">Better Coordination</p>
                  <p className="mt-2 text-sm text-white/90">Everyone responds together</p>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-blue-100">Safer Neighborhoods</p>
                  <p className="mt-2 text-sm text-white/90">Reduced emergency delays</p>
                </div>
                <div className="rounded-2xl bg-white/10 p-4 backdrop-blur">
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-blue-100">Shared Response</p>
                  <p className="mt-2 text-sm text-white/90">Help reaches the right place faster</p>
                </div>
              </div>
            </Reveal>
            ...
            <div className="space-y-4">
              {[
                ['Faster Awareness', 'Communities know instantly'],
                ['Better Coordination', 'Everyone responds together'],
                ['Safer Neighborhoods', 'Reduced emergency delays'],
              ].map(([title, text], index) => (
                <Reveal key={title} delay={index * 0.05} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.05)]">
        ...
        <section className="px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-7xl">
            <SectionTitle
              ...
              description="Jirani Alert changes the experience from reactive and delayed to coordinated and immediate."
            />

            <Reveal className="mt-10 overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-[0_24px_70px_rgba(15,23,42,0.08)]">
              <div className="grid md:grid-cols-2">
                <div className="border-b border-slate-200 bg-slate-50 p-6 md:border-b-0 md:border-r">
                  <p className="text-xs font-black uppercase tracking-[0.24em] text-slate-400">Without Jirani Alert</p>
                  <div className="mt-5 space-y-3 text-sm text-slate-600">
                    <p>Delayed awareness</p>
                    <p>Slow communication</p>
                    <p>Uncoordinated response</p>
                  </div>
                </div>
                <div className="bg-[linear-gradient(135deg,#0f2458_0%,#163b82_100%)] p-6 text-white">
                  <p className="text-xs font-black uppercase tracking-[0.24em] text-blue-100">With Jirani Alert</p>
        ...
        <section className="px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-7xl">
            <SectionTitle
              ...
              title="What people feel when the platform works"
              description="The experience is built to be reassuring, clear, and useful when communities need it most."
            />

            <div className="mt-10 grid gap-4 lg:grid-cols-2">
              {testimonials.map((quote, index) => (
                <Reveal key={quote} delay={index * 0.04} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.05)]">
                  <div className="flex items-center gap-2 text-amber-500">
                    {[...Array(5)].map((_, starIndex) => (
                      <ShieldCheck key={`${quote}-${starIndex}`} className="h-4 w-4" />
                    ))}
                  </div>
                  <p className="mt-4 text-lg leading-8 text-slate-700">{quote}</p>
                </Reveal>
              ))}
            </div>
          </div>
        ...
        <section className="px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <div className="mx-auto max-w-7xl">
            <Reveal className="rounded-[2rem] border border-slate-200 bg-[linear-gradient(135deg,#153b82_0%,#0f2458_100%)] p-8 text-center text-white shadow-[0_28px_80px_rgba(15,23,42,0.16)] sm:p-12">
              <h2 className="text-3xl font-black tracking-tight sm:text-4xl lg:text-5xl">Experience Smarter Community Safety</h2>
              <p className="mx-auto mt-4 max-w-2xl text-base leading-8 text-blue-50/90 sm:text-lg">
                Explore the platform built to keep neighborhoods informed and protected.
              </p>
